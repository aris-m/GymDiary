...
urlpatterns = [
    path('', views.progress, name='index'),
    ...
    path('friend-progress/<int:friend_id>/', views.friend_progress, name='friend-progress'),
    ...
    path('send-friend-request/<int:friend_id>/', views.send_friend_request, name='send-friend-request'),
